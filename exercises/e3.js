...
function getValueWithConditionOne(valueA, valueB) {
  if (valueA === 40 && valueB === 40) {
    return valueA + valueB;
  } else return (valueA + valueB) * 2;
}

console.log(getValueWithConditionOne(40, 40));
console.log(getValueWithConditionOne(20, 30));

const getValueWithConditionTwo = (valueA, valueB) => {
  if (valueA === 40 && valueB === 40) {
    return valueA + valueB;
  } else return (valueA + valueB) * 2;
};
...
const getValueWithConditionThree = function (valueA, valueB) {
  if (valueA === 40 && valueB === 40) {
    return valueA + valueB;
  } else return (valueA + valueB) * 2;
};
