...
function logMyMessage(testMessage) {
  console.log(testMessage);
}

logMyMessage("Test logMyMessage: Test 1");
...
function logMyInfo(firstName, myAge) {
  console.log(`My name is ${firstName}. I am ${myAge} years old!`);
}
